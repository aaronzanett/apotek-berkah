<?php
$data['supply'] = $this->model('SupplyModel')->getAllSupplyByIdOutlet($_SESSION['outlet_id']);
?>
...
<script>
                ...
                success: function (data) {
                    ...
                    for (let i = 0; i < supplyD.length; i++) {
                        ...
                        <tr>
                            ...
                            <td class="detailData">Rp. `+formatRibuan(p.supply_price)+`</td>
                        </tr>
                        <tr>
    ...
    $('.tabledata-supply-search').on('input', function() {
        ...
        $.ajax({
            url: "<?= BASEURL ?>/headofficeOpp/searchSupplyByIdOutlet",
