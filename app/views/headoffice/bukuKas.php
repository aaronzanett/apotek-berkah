...
<section id="bukuKas">
    <div class="tabledata shadow">
        ...
        <div class="tabledata-header">
            ...
            <h3 class="saldoSaatIni">Saldo: Rp. <?= number_format($data['saldoHeadoffice'],0,",","."); ?></h3>
        </div>

        <div class="tabledata-subheader">
            <p class="tabledata-totaldata">Total <?= count($data['bukuKasHeadoffice']) ?> transaksi</p>
        </div>
        ...
        <div class="tabledata-body">
            <div class="tabledata-body-overflow-lg">
                ...
                <div id="tabledata-items">
                    <?php if (count($data['bukuKasHeadoffice']) !== 0) { ?>
                        <?php $i = 1; foreach ($data['bukuKasHeadoffice'] as $b ) : ?>
                            <div class="tabledata-item">
                                ...
                                <div class="tabledata-actions">
                                    ...
                                    <a href="<?= BASEURL ?>/headofficeOpp/deletebukuKas/<?= $b['id'] ?>" class="action alertConfirm"><i class="bi bi-trash"></i></a>
                                </div>
                                <?php endif; ?> -->
                            </div>
                        <?php endforeach;?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-data">
                <div class="modal-body">
                    <form action="<?= BASEURL ?>/headofficeOpp/addBukuKas" method="post">
...
<script>
    ...
    $(".add-bukuKas").on("click", function () {
        ...
        $(".modal-body form").attr("action", "<?= BASEURL ?>/headofficeOpp/addBukuKas" );
    ...
    function crudOperation(){
        ...
        $(".edit-bukuKas").on("click", function () {
            ...
            $(".modal-body form").attr("action", "<?= BASEURL ?>/headofficeOpp/editBukuKas");
            $('.configAlert').addClass('d-none');
            $(".modal-footer button[type=submit]").removeClass('disabled');
            ...
            $.ajax({
                url: "<?= BASEURL ?>/headofficeOpp/getDataEditBukuKas",
                data: {id: id},
                method: "post",
                dataType: "json",
