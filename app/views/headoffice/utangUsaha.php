<?php
$data['utangHeadoffice'] = $this->model('UtangPiutang')->getAllUtang();
?>
        ...
        <div class="tabledata-body">
            <div class="tabledata-body-overflow-lg">
                ...
                <div id="tabledata-items">
                    <?php if (count($data['utangHeadoffice']) !== 0) { ?>
                        <?php $i = 1; foreach ($data['utangHeadoffice'] as $utang ) : ?>
                            <div class="tabledata-item">
                                ...
                                <div class="tabledata-actions">
                                    <div class="action openModalBtn bayar-utang" data-id="<?= $utang['id'] ?>" data-sisautang="<?= $utang['total_sisa'] ?>" data-faktur="<?= $utang['faktur'] ?>"><i class="bi bi-cash-stack"></i></i></div>
                                </div>
                            </div>
                        <?php endforeach;?>
                    <?php } else { ?>
